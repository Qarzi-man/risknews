...
RSS_FEEDS = [
    ...
    # Kitco и Reuters заменены на рабочие альтернативы
    {"url": "https://www.mining.com/feed/",                      "name": "Mining.com"},
    {"url": "https://www.reuters.com/rssFeed/businessNews",      "name": "Reuters"},
...
async def fetch_telegram_channel(client: httpx.AsyncClient, channel: str) -> list:
    """Пробует несколько rsshub инстансов по очереди."""
